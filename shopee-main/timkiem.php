                ...
                <nav class="header__navbar hide-on-mobile-tablet">
                    ...
                    <ul class="header__nav-list">
                        ...
                        <li class="header__nav-item header__nav-item--bold">
                            <a href="#" class="header__nav-item-link"><?php echo $_SESSION['username']; ?></a>
                        </li>
                        <a href="../DangKyKhachHang/dangnhap.php" class="header__nav-item-link">Đăng xuất</a>
                    ...
                    <div class="col l-10 m-12 c-12">
                        ...
                        <div class="home-product">
                            ...
                            <div id="list-product" class="row sm-gutter">
                                ...
                                $sql = "SELECT * FROM SanPham WHERE TenSanPham LIKE '%" . $search_keyword . "%'";
                                $result = $conn->query($sql);

                                if ($result->num_rows > 0) {
                                    while ($row = $result->fetch_assoc()) {
                                        echo '<div class="col l-2-4 m-3 c-6 home-product-item">';
                                        echo '<a class="home-product-item-link" href="#">';
                                        ...
                                        echo '</div>';
                                        echo '</div>';
                                        echo '<div class="home-product-item-footer">Tìm sản phẩm tương tự</div>';
                                        echo '</a>';
                                        echo '</div>';
                                    }
                                } else {
